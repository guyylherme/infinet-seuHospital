...
<body>
	...
	<div class="container mb-5">
		...
		<div class="container mt-3">
			<h2 class="mb-3">Cadastramento de Dentista</h2>
			<form action="/dentista/incluir" method="POST">
				...
				<div class="row mt-2">
					...
					<div class="col">
						...
						<select name="atendeCrianca" class="form-control">
					...
					<div class="col">
						<label for="cirurgia" >Realiza cirurgia:</label>
